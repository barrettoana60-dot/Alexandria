...
#MainMenu,footer,.stDeployButton,[data-testid="stToolbar"],[data-testid="stDecoration"],[data-testid="collapsedControl"]{display:none!important}
...
section[data-testid="stSidebar"]{
  ...
  box-shadow:1px 0 30px rgba(0,0,0,.4),inset -1px 0 0 rgba(255,255,255,.04)!important;
...
.snav .stButton>button{
  ...
  font-family:'DM Sans',sans-serif!important;font-weight:500!important;font-size:.85rem!important;
  ...
  height:auto!important;min-height:auto!important;margin-bottom:.18rem;
  letter-spacing:.005em!important;
}
.snav .stButton>button:hover{
  background:var(--g1)!important;border-color:var(--gb1)!important;
...
.snav-a.yel .stButton>button{color:var(--yel)!important;border-color:rgba(255,214,10,.25)!important;background:rgba(255,214,10,.08)!important;}
.snav-a.grn .stButton>button{color:var(--grn)!important;border-color:rgba(6,214,160,.25)!important;background:rgba(6,214,160,.08)!important;}
.snav-a.blu .stButton>button{color:var(--blu)!important;border-color:rgba(76,201,240,.25)!important;background:rgba(76,201,240,.08)!important;}
.snav-a.red .stButton>button{color:var(--red)!important;border-color:rgba(255,59,92,.25)!important;background:rgba(255,59,92,.08)!important;}
.snav-a.pur .stButton>button{color:var(--pur)!important;border-color:rgba(177,125,255,.25)!important;background:rgba(177,125,255,.08)!important;}
.snav-a.orn .stButton>button{color:var(--orn)!important;border-color:rgba(255,140,66,.25)!important;background:rgba(255,140,66,.08)!important;}
